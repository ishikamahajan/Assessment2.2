...
/**
 * The SocialGraph class represents the social graph.
 * This is an undirected, weighted graph using Persons to represent the vertexes of the graph.
 * Edges are represented by the Person list contained in each of the vertices.
 * The SocialGraph class has a list of all the vertices within the graph.
 * This is stored as an ArrayList<Person> called vertices.
 */
public class SocialGraph {
     ...
     * @param a person
     * @param b person
     * @throws EdgeDoesNotExist if edge doesn't exist between given vertex
     */
     ...
     *
     * @param start person
     * @return number of contacts 2 steps away from the start node.
     * @throws PersonDoesNotExist if either start or target are not in the graph.
     */
